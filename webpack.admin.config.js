 ...
 * @LastEditTime: 2020-07-20 14:17:31
 */
...
module.exports = {
  ...
  devServer: { // webpack-dev-server配置热更新以及跨域
    ...
    proxy: process.env.ENV === 'loc' ? {
      '/nuskin-hk': {
        // target: "http://172.16.18.112:8900", // 112
        // target: "http://hzdev.dtyunxi.cn/nuskinhk/test", // 113
        // target: 'https://nutowntest.nuskin.com.hk', // QA1
        // target: 'https://nutowntest2.nuskin.com.hk', // QA2
        target: 'https://nutownstage.nuskin.com.hk', // stage
        // pathRewrite: { '^/nuskin-hk-app-admin/api/v1/nuskin/admin': '' },
        changeOrigin: true,
      },
    } : {},
  },
